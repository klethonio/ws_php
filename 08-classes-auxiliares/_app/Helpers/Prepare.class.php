...
class Prepare
{
     ...
     */
    public static function dateToTimestap(string $date) {
     ...
     * @return string
     */
    public static function shortenString(string $string, int $limit, string $strEnd = '...') {
     ...
     */
    public static function getImage(string $name, string $description, $width = 0, $height = 0) {
        $image = 'uploads/'.$name;
        $width = (int) $width;
        $height = (int) $height;
        if(is_file($image)){
