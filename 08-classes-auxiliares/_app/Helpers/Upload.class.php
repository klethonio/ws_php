...
class Upload
{
     ...
     */
    public function uploadImage(array $file, $name = null, $width = 1024, $folder = 'images') {
        $this->file = $file;
     ...
     */
    public function uploadFile(array $file, $name = null, $folder = 'files', $maxSize = 2) {
        $this->file = $file;
        $this->name = (string) $name ? $name : substr($this->file['name'], 0, strrpos($this->file['name'], '.'));
     ...
     * @param int $maxSize (MB)
     */
    public function uploadMedia(array $file, $name = null, $folder = 'medias', $maxSize = 20) {
        $this->file = $file;
        $this->name = (string) $name ? $name : substr($this->file['name'], 0, strrpos($this->file['name'], '.'));
