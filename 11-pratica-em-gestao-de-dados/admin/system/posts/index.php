<div class="content list_content">
    ...
    <section>
        ...
        if ($action) {
            ...
            switch ($action) {
                case 'delete':
                    list($msg, $err) = $delete->exeDelete($postId);
                    break;
                
                case 'toggle':
                    list($msg, $err) = $delete->exeToggleStatus($postId);
                    break;
        ...
        ?>
            <article<?php if ($i % 2 == 0) echo ' class="right" '; ?><?php if (!$post_status) echo ' style="background: #dfdfdf " ';?>>
                ...
                <ul class="info post_actions">
                    ...
                    <li><a class="act_edit" href="painel.php?view=posts/update&id=<?=$post_id?>" title="Editar">Editar</a></li>
                    <?php if (!$post_status) { ?>
                    <li><a class="act_ative" href="painel.php?view=posts/index&id=<?=$post_id?>&action=toggle" title="Ativar">Ativar</a></li>
                    <?php } else { ?>
                    <li><a class="act_inative" href="painel.php?view=posts/index&id=<?=$post_id?>&action=toggle" title="Inativar">Inativar</a></li>
                    <?php } ?>
                    <li><a class="act_delete" href="painel.php?view=posts/index&id=<?=$post_id?>&action=delete" title="Excluir">Deletar</a></li>
                </ul>
