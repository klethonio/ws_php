...
class Read extends Conn
{
     ...
     */
    public function exeRead(string $table, string $condition = null, array $params = null): void
    {
     ...
     */
    public function exeQuery(string $query, array $params = null): void
    {
        $this->query = $query;
        $this->params = $params;
        $this->allowNewRead = true;
     ...
     * @param array $params = [link => $link, link_int => {$link_int}] (_int for integer)
     */
    public function exeNewRead(array $params): void
    {
